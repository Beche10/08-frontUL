    ...
    <div className="w-[90%] bg-color-background mx-auto overflow-hidden max-w-screen-xl font-dm-sans text-white">
      ...
      <div>
        <img
          ...
          alt="LogoPartido"
        />
        <h1 className="text-white text-4xl mt-4 grid grid-cols-auto grid-rows-auto items-center justify-center">
          404
        </h1>
        <h2 className="text-white text-3xl grid grid-cols-auto grid-rows-auto items-center justify-center">
          PAGE NOT FOUND
        </h2>
      </div>
    </div>
